...
def translate_it(path_file, path_result, from_lang, to_lang):
...
if __name__ == '__main__':
    translate_it('DE.txt', 'translate_DE.txt', 'de', 'ru')
    translate_it('ES.txt', 'translate_ES.txt', 'es', 'ru')
    translate_it('FR.txt', 'translate_FR.txt', 'fr', 'ru')
